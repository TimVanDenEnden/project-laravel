   ...
   <div class="row">
        <div class='col-sm-12 col-md-6 col-lg-6'>
            <div class="card card-no-hover">
                <h3 class='padding-h3'>Add Task</h3>
                <form action="/add" method="post"> 
                    ...
                    <textarea rows="4" cols="50" class="input-field" placeholder="Description.." name="description"></textarea>
   ...
   <div class="row">
        <div class='col-sm-12 col-md-6 col-lg-6'>
            <div class="card card-no-hover">
                ...
                <form action="/add" method="post"> 
                    <input type="text" class="input-field" placeholder="Title.." name="title" value="<?= $title ?>">
    
                    <!-- Token need to execute  -->
                    <input type="hidden" name="_token" id="csrf-token" value="{{ Session::token() }}" />

                    <textarea rows="4" cols="50" class="input-field" placeholder="Description.." name="description"><?= $description ?></textarea>
                    <button type="submit" class="btn">Add Task</button> 
                </form> 
            </div>
        </div>
